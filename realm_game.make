...
ifeq ($(config),debug)
TARGETDIR = bin/Debug-windows-x86_64/realm_game
TARGET = $(TARGETDIR)/realm_game.exe
OBJDIR = obj/Debug-windows-x86_64/realm_game
...
TARGET = $(TARGETDIR)/realm_game.exe
OBJDIR = obj/Release-windows-x86_64/realm_game
...
$(OBJDIR)/resource.o: src/resource.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(ALL_CFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
